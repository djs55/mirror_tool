...
(* OASIS_START *)
(* DO NOT EDIT (digest: 93b636852a84afcdaca2b56e97e5c682) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "mirror_tool.ml"})
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "Jqr3w(\191A\243\185\215\171F\147\019\025";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
